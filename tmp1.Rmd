...
tabsetPanel(type = "tabs",
            tabPanel("Precipitation", highchartOutput('precipGraph', height = "100%")),
            tabPanel("Monthly flows", highchartOutput("catchAggGraph", height = "100%")),
            tabPanel("Temperature" , highchartOutput("tempGraph", height = "100%")),
            tabPanel("Water use", highchartOutput("waterUseGraph", height = "100%")))
