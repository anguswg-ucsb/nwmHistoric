...
shinydashboard::tabBox(width=12,
      title = "First tabBox",
      id = "tabset1",
      tabPanel("TabA", dygraphOutput ('precipGraph')),
      tabPanel("TabB", plotlyOutput("tempGraph"))
    )
# {.tabset data-width=400}
# fillRow(flex = c(NA, 1),
# miniTabstripPanel(
#                   miniTabPanel("Visualize", icon = icon("area-chart"),
#                     miniContentPanel(dygraphOutput ('precipGraph'), height="100%")),
#                   miniTabPanel("Parameters", icon = icon("sliders"),    
#                     miniContentPanel(dygraphOutput("evapGraph"), height="100%")),
#                   miniTabPanel("Map", icon = icon("map-o"),
#                     miniContentPanel(plotlyOutput("catchAggGraph"), height="100%")),
#                   miniTabPanel("Data", icon = icon("table"),
#                     miniContentPanel(plotlyOutput("tempGraph"), height="100%")),
#                   miniTabPanel("Water", icon = icon("water"),
#                     miniContentPanel(plotlyOutput("waterUseGraph"), height="100%")))
...
tempData <- eventReactive(input$dateButton, {
    ...
    plot_ly(temp, x = ~month, y = ~meanMax, type = 'bar',  width = 600, height = 400,
                  textposition = 'auto',
                  name = "Max",
                  marker = list(color = 'rgba(219, 64, 82, 0.7)',
                              line = list(color = 'rgba(219, 64, 82, 1.0)',
